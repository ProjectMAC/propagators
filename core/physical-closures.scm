...
(define (p:application prop-cell . arg-cells)
  (let ((arg-cells (map ensure-cell arg-cells)))
    (if (cell? prop-cell)
	(if (directly-applicable? (content prop-cell))
	    (eager-diagram-apply (content prop-cell) arg-cells)
	    (general-propagator-apply prop-cell arg-cells))
	(if (directly-applicable? prop-cell)
	    (eager-diagram-apply prop-cell arg-cells)
	    (general-propagator-apply (ensure-cell prop-cell) arg-cells)))))
...
(define (application prop-cell . arg-cells)
  (let ((arg-cells (map ensure-cell arg-cells)))
    ...
    (if (cell? prop-cell)
	(if (directly-applicable? (content prop-cell))
	    (eager-apply (content prop-cell) arg-cells)
	    (general-propagator-apply prop-cell arg-cells))
	(if (directly-applicable? prop-cell)
	    (eager-apply prop-cell arg-cells)
	    (general-propagator-apply (ensure-cell prop-cell) arg-cells)))))
