...
(pp (experiment-result (list (make-list 10 'heads))))
(pp (experiment-result '((heads) (heads))))
(pp (experiment-result '((heads) (heads) (heads))))
(pp (experiment-result (make-list 4 '(heads))))
(pp (experiment-result (list (make-list 200 'heads))))
(pp (experiment-result (list (make-list 200 'tails))))
(pp (experiment-result (make-list 200 '(tails))))
